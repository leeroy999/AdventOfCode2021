...
function part1()
    function arr_letters(sub_arr)
        seen = sub_arr[1]
        if #sub_arr ~= 1 then
            for j = 2, #sub_arr do
                for c in string.gmatch(sub_arr[j], ".") do
                    if string.match(seen, c) == nil then
                        seen = seen .. c
                    end
                end
            end
    ...
    sum_counts = 0
    for i = 1, #arr do
        sum_counts = sum_counts + arr_letters(arr[i])
    end
    print(sum_counts)
    return sum_counts
end
function part2()
    function arr_letters(sub_arr)
        ...
        if #sub_arr ~= 1 then
            for j = 2, #sub_arr do
                for c in string.gmatch(seen, ".") do
                    if string.match(sub_arr[j], c) == nil then
                        seen = string.gsub(seen, c, '')
                    end
                end
            end
        end
